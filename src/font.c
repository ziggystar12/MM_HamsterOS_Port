...
/*
 * Standard IBM PC 8x8 CP437 font bitmap.
 * Each character is 8 bytes, one per row, MSB = leftmost pixel.
 * This is the classic VGA BIOS 8x8 font.
 */
const uint8_t font_data[256][8] = {
    ...
    /* 0x4A */ {0x1E,0x06,0x06,0x06,0xC6,0xC6,0x7C,0x00},
    ...
    /* 0x54 */ {0xFF,0x18,0x18,0x18,0x18,0x18,0x18,0x00},
    ...
    /* 0x58 */ {0xC6,0x6C,0x38,0x38,0x38,0x6C,0xC6,0x00},
    /* 0x59 */ {0xCC,0xCC,0xCC,0x78,0x18,0x18,0x3C,0x00},
    /* 0x5A */ {0xFE,0x0C,0x18,0x30,0x60,0xC0,0xFE,0x00},
    ...
    /* 0x63 */ {0x00,0x00,0x7C,0xC0,0xC0,0xC6,0x7C,0x00},
    ...
    /* 0x6A */ {0x06,0x00,0x06,0x06,0x06,0xC6,0xC6,0x7C},
    /* 0x6B */ {0xC0,0xC0,0xCC,0xD8,0xF0,0xD8,0xCC,0x00},
    /* 0x6C */ {0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x00},
    ...
    /* 0x72 */ {0x00,0x00,0xDC,0xE0,0xC0,0xC0,0xC0,0x00},
    /* 0x73 */ {0x00,0x00,0x7C,0xC0,0x7C,0x06,0x7C,0x00},
    /* 0x74 */ {0x30,0x30,0x7C,0x30,0x30,0x36,0x1C,0x00},
    /* 0x75 */ {0x00,0x00,0xC6,0xC6,0xC6,0xC6,0x7E,0x00},
    ...
    /* 0x79 */ {0x00,0x00,0xC6,0xC6,0x7E,0x06,0x7C,0x00},
    /* 0x7A */ {0x00,0x00,0xFE,0x0C,0x18,0x30,0xFE,0x00},
    ...
    /* 0x81 */ {0x66,0x00,0x66,0x66,0x66,0x66,0x3E,0x00},
    /* 0x82 */ {0x0C,0x18,0x7C,0xC6,0xFE,0xC0,0x7C,0x00},
    /* 0x83 */ {0x7C,0xC6,0x3C,0x06,0x7E,0xC6,0x7E,0x00},
    /* 0x84 */ {0x66,0x00,0x3C,0x06,0x7E,0xC6,0x7E,0x00},
    /* 0x85 */ {0x30,0x18,0x3C,0x06,0x7E,0xC6,0x7E,0x00},
    /* 0x86 */ {0x3C,0x66,0x3C,0x06,0x7E,0xC6,0x7E,0x00},
    /* 0x87 */ {0x00,0x00,0x7C,0xC0,0xC0,0xC6,0x7C,0x30},
    /* 0x88 */ {0x7C,0xC6,0x7C,0xC6,0xFE,0xC0,0x7C,0x00},
    /* 0x89 */ {0x66,0x00,0x7C,0xC6,0xFE,0xC0,0x7C,0x00},
    /* 0x8A */ {0x30,0x18,0x7C,0xC6,0xFE,0xC0,0x7C,0x00},
    /* 0x8B */ {0x66,0x00,0x18,0x18,0x18,0x18,0x18,0x00},
    /* 0x8C */ {0x7C,0xC6,0x18,0x18,0x18,0x18,0x18,0x00},
    /* 0x8D */ {0x30,0x18,0x18,0x18,0x18,0x18,0x18,0x00},
    /* 0x8E */ {0xC6,0x38,0x6C,0xC6,0xFE,0xC6,0xC6,0x00},
    /* 0x8F */ {0x38,0x6C,0x7C,0xC6,0xFE,0xC6,0xC6,0x00},
    /* 0x90 */ {0x0C,0x18,0xFE,0xC0,0xF8,0xC0,0xFE,0x00},
    /* 0x91 */ {0x00,0x00,0x7E,0x18,0x7E,0xD8,0x7E,0x00},
    /* 0x92 */ {0x3E,0x6C,0xCC,0xFE,0xCC,0xCC,0xCE,0x00},
    /* 0x93 */ {0x7C,0xC6,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},
    /* 0x94 */ {0x66,0x00,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},
    /* 0x95 */ {0x30,0x18,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},
    /* 0x96 */ {0x7C,0xC6,0xC6,0xC6,0xC6,0x66,0x36,0x00},
    /* 0x97 */ {0x30,0x18,0xC6,0xC6,0xC6,0xC6,0x7E,0x00},
    /* 0x98 */ {0x66,0x00,0xCC,0xCC,0x78,0x18,0x3C,0x00},
    ...
    /* 0x9D */ {0xC6,0xC6,0x7C,0x38,0x7C,0x6C,0xC6,0x00},
    /* 0x9E */ {0xFC,0x64,0x60,0x7C,0x60,0x60,0xFC,0x00},
    /* 0x9F */ {0x00,0x06,0x7C,0xD8,0xD8,0x7C,0xC0,0x00},
    /* 0xA0 */ {0x0C,0x18,0x7C,0x06,0x7E,0xC6,0x7E,0x00},
    /* 0xA1 */ {0x0C,0x18,0x00,0x18,0x18,0x18,0x18,0x00},
    /* 0xA2 */ {0x0C,0x18,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},
    /* 0xA3 */ {0x0C,0x18,0xC6,0xC6,0xC6,0xC6,0x7E,0x00},
    /* 0xA4 */ {0x76,0xDC,0x00,0xFC,0xC6,0xC6,0xC6,0x00},
    /* 0xA5 */ {0x76,0xDC,0xC6,0xE6,0xF6,0xDE,0xCE,0x00},
    /* 0xA6 */ {0x3C,0x6C,0x6C,0x3E,0x00,0x7E,0x00,0x00},
    /* 0xA7 */ {0x38,0x6C,0x6C,0x38,0x00,0x7C,0x00,0x00},
    /* 0xA8 */ {0x18,0x00,0x18,0x30,0x60,0xC6,0x7C,0x00},
    /* 0xA9 */ {0x00,0x00,0x00,0xFE,0xC0,0xC0,0x00,0x00},
    /* 0xAA */ {0x00,0x00,0x00,0xFE,0x06,0x06,0x00,0x00},
    /* 0xAB */ {0x60,0xE0,0x62,0x66,0x0C,0x18,0x36,0x6F},
    /* 0xAC */ {0x60,0xE0,0x64,0x6C,0x1E,0x33,0x7F,0x03},
    ...
    /* 0xE0 */ {0x00,0x00,0x76,0xDC,0xD8,0xDC,0x76,0x00},
    /* 0xE1 */ {0x00,0x78,0xCC,0xF8,0xCC,0xF8,0xC0,0xC0},
    /* 0xE2 */ {0x00,0xFE,0xC6,0xC0,0xC0,0xC0,0xC0,0x00},
    /* 0xE3 */ {0x00,0x00,0xFE,0x6C,0x6C,0x6C,0x6C,0x00},
    /* 0xE4 */ {0x00,0xFE,0xC6,0x60,0x30,0x60,0xC6,0xFE},
    /* 0xE5 */ {0x00,0x00,0x7E,0xD8,0xD8,0xD8,0x70,0x00},
    /* 0xE6 */ {0x00,0x00,0x66,0x66,0x66,0x66,0x7C,0xC0},
    /* 0xE7 */ {0x00,0x00,0x76,0xDC,0x18,0x18,0x18,0x00},
    /* 0xE8 */ {0x00,0x7E,0x18,0x3C,0x66,0x66,0x3C,0x18},
    /* 0xE9 */ {0x00,0x38,0x6C,0xC6,0xFE,0xC6,0x6C,0x38},
    /* 0xEA */ {0x00,0x38,0x6C,0xC6,0xC6,0x6C,0x6C,0xEE},
    /* 0xEB */ {0x00,0x1E,0x30,0x18,0x7C,0xCC,0xCC,0x78},
    /* 0xEC */ {0x00,0x00,0x7E,0xDB,0xDB,0x7E,0x00,0x00},
    /* 0xED */ {0x00,0x06,0x7E,0xDB,0xDB,0x7E,0x60,0x00},
    /* 0xEE */ {0x00,0x1C,0x30,0x60,0x7C,0x60,0x30,0x1C},
    /* 0xEF */ {0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x00},
    /* 0xF0 */ {0x00,0x7E,0x00,0x7E,0x00,0x7E,0x00,0x00},
    /* 0xF1 */ {0x00,0x18,0x18,0x7E,0x18,0x18,0x00,0x7E},
    /* 0xF2 */ {0x00,0x60,0x30,0x18,0x30,0x60,0x00,0x7E},
    /* 0xF3 */ {0x00,0x06,0x0C,0x18,0x0C,0x06,0x00,0x7E},
    /* 0xF4 */ {0x00,0x0E,0x1B,0x1B,0x18,0x18,0x18,0x18},
    /* 0xF5 */ {0x18,0x18,0x18,0x18,0xD8,0xD8,0x70,0x00},
    /* 0xF6 */ {0x00,0x18,0x18,0x00,0x7E,0x00,0x18,0x18},
    ...
    /* 0xFC */ {0x58,0x6C,0x6C,0x6C,0x6C,0x00,0x00,0x00},
    /* 0xFD */ {0x70,0x98,0x30,0x60,0xF8,0x00,0x00,0x00},
                  ...
                  uint8_t color, int scale)
{
    ...
    int row, col_bit, dy, dx;

    if (scale < 1) scale = 1;
    for (row = 0; row < FONT_H; row++) {
        uint8_t bits = glyph[row];
        for (col_bit = 0; col_bit < FONT_W; col_bit++) {
            if (bits & (0x80 >> col_bit)) {
                for (dy = 0; dy < scale; dy++) {
                    for (dx = 0; dx < scale; dx++) {
                        int px = sx + col_bit * scale + dx;
                        int py = sy + row    * scale + dy;
                        if (px >= 0 && py >= 0)
                            buf[(uint32_t)py * stride + (uint32_t)px] = color;
                    }
                }
            }
        }
                ...
                uint8_t color, int scale)
{
    int x = sx;
    while (*s) {
        font_putchar(buf, stride, (unsigned char)*s, x, sy, color, scale);
        x += FONT_W * scale;
        s++;
    }
}
